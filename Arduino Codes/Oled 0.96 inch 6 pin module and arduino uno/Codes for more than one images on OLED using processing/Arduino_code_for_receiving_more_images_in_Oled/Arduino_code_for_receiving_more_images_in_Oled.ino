...
if (stringComplete) {
    ...
    for(int i = 0; i < 1024; i++)
  {
    ...
    int index = inputString.indexOf(","); //We find the next comma
    logo[i]= atol(inputString.substring(0,index).c_str()); //Extract the number
    inputString = inputString.substring(index+1); //Remove the number from the string
  }
